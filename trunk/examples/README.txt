...
rl1/booklet.py -- Version of print_booklet using reportlab for output.  Good example of using
                  (well-supported) Form XObjects with reportlab

rl2/copy.py -- example of how you could parse a graphics stream and then use reportlab for output.
               functions a little on a few PDFs.
